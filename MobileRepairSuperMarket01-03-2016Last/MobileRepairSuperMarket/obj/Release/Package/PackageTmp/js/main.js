...
/*----- price range ui slider js -----*/	
	$( "#price-range" ).slider({
		...
		slide: function( event, ui ) {
		    jQuery("#slidevalue").html("<span class='pull-left'>Min " + ui.values[0] + "</span><span class='pull-right'>Max " + ui.values[1] + "</span>");
		}
	});
	...
	$("#display-range").slider({
	    ...
	    values: [2.0, 6.0],
	    slide: function (event, ui) {
	        jQuery("#display").html("<span class='pull-left'>Min " + ui.values[0] + " inches</span><span class='pull-right'>Max " + ui.values[1] + " inches</span>");
	    }
	});
	jQuery("#display").val("$" + $("#display-range").slider("values", 0) +
		"      $" + $("#display-range").slider("values", 1));
	...
	$("#battery-range").slider({
	    ...
	    values: [700, 400],
	    slide: function (event, ui) {
	        jQuery("#battery").html("<span class='pull-left'>Min " + ui.values[0] + " mAh</span><span class='pull-right'>Max " + ui.values[1] + " mAh</span>");
	    }
	});
	jQuery("#battery").val("$" + $("#display-range").slider("values", 0) +
		"      $" + $("#battery-range").slider("values", 1));
